	...
	registerBlockType(
		'emma/slider',
		{
			...
			edit: withColors( 'arrowColor' )( function( props ) {
				...
				var settingsJSONControl =  el(
					...
					el(
						...
						{
							value: settingsJSON,
							help: htmlToElem( 'Enter JSON properties for additional settings found <a href="https://splidejs.com/guides/options/" target="_blank">here</a>. Make sure there are not quotes around numeric values!' ),
				...
				return (
					el(
						...
						el(
							'div',
							{
								className: props.className + " columns-" + props.attributes.editorColumns
							},
							el(
								InnerBlocks,
								{
			...
			save: function( props ) {
				...
				var settings = {};
				var wrapperClasses = "splide__wrapper " + ( getColorClassName( 'arrow-color', a.arrowColor ) || '' );
				...
				if( a.showArrows ) {
					arrowNav = el(
						'div',
						{
							...
							"data-splide-el": "controls",
						},
						el(
							'button',
							{
								className: "splide__arrow splide__arrow__prev lg-ignore",
								"data-glide-dir": "<"
							},
							el(
								'span',
						...
						el(
							'button',
							{
								className: "splide__arrow splide__arrow--next lg-ignore",
								"data-glide-dir": ">"
							},
							el(
								'span',
					...
					if( a.outerArrows ) {
						wrapperClasses += " splide__outer-arrows";
					}
				}
				*/
				...
				if( a.controlNav == 'dots' ) {
					...
					for( let i = 0; i < slideCount; i++ ) {
						...
						el(
							...
							{
								href: "#",
								className: "splide__bullet lg-ignore",
								"data-splide-dir": "=" + i,
							},
							el(
								'span',
				...
				bulletNav = el(
					'div',
					{
						className: "splide__bullets",
						"data-splide-el": "controls[nav]",
					},
					bullets,
				);
			}
...
/**
 * Register the Slide block (child of Slider)
 */
( function( editor, element ) {
					...
					el(
						...
						el(
							'div',
							{
								...
								'data-thumb': props.attributes.thumbnailURL
							},
							el(
								InnerBlocks,
								{
